...
'use strict'; (function (a) { "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/modules/export-data", ["highcharts", "highcharts/modules/exporting"], function (k) { a(k); a.Highcharts = k; return a }) : a("undefined" !== typeof Highcharts ? Highcharts : void 0) })(function (a) {
    function k(a, f, d, p) { a.hasOwnProperty(f) || (a[f] = p.apply(null, d)) } a = a ? a._modules : {}; k(a, "Extensions/DownloadURL.js", [a["Core/Globals.js"]], function (a) {
        ...
        d = a.win, p = d.document, l = d.URL || d.webkitURL || d, r = a.dataURLtoBlob = function (a) { if ((a = a.replace(/filename=.*;/, "").match(/data:([^;]*)(;base64)?,([0-9A-Za-z+/]+)/)) && 3 < a.length && d.atob && d.ArrayBuffer && d.Uint8Array && d.Blob && l.createObjectURL) { var f = d.atob(a[3]), m = new d.ArrayBuffer(f.length); m = new d.Uint8Array(m); for (var b = 0; b < m.length; ++b)m[b] = f.charCodeAt(b); a = new d.Blob([m], { type: a[1] }); return l.createObjectURL(a) } }; a = a.downloadURL = function (a, l) {
            var m = d.navigator, b = p.createElement("a"); if ("string" ===
        ...
        function k(a, n) {
            var c = g.navigator, b = -1 < c.userAgent.indexOf("WebKit") && 0 > c.userAgent.indexOf("Chrome"), d = g.URL || g.webkitURL || g; try {
                if (c.msSaveOrOpenBlob && g.MSBlobBuilder) { var t = new g.MSBlobBuilder; t.append(a); return t.getBlob("image/svg+xml") } if (!b) return d.createObjectURL(new g.Blob(["\ufeff" +
                    a], { type: n }))
            } catch (N) { }
        } var I = p.doc, b = p.seriesTypes, g = p.win; p = l.getOptions; l = l.setOptions; var E = r.addEvent, J = r.defined, F = r.extend, K = r.find, C = r.fireEvent, L = r.isNumber, v = r.pick, G = m.downloadURL; l({
            ...
            y = this.time, b = this.options.exporting && this.options.exporting.csv || {}, d = this.xAxis, t = {}, f = [], m = [], p = [], z; var g = this.options.lang.exportData; var l = g.categoryHeader, M = g.categoryDatetimeHeader, w = function (q, e, d) { if (b.columnHeaderFormatter) { var n = b.columnHeaderFormatter(q, e, d); if (!1 !== n) return n } return q ? q instanceof a ? q.options.title && q.options.title.text || (q.dateTime ? M : l) : c ? { columnTitle: 1 < d ? e : q.name, topLevelColumnTitle: q.name } : q.name + (1 < d ? " (" + e + ")" : "") : l }, H = function (a, c, e) {
                ...
                var e =
                    a.xAxis, q = a.options.keys || r(a, e), f = q.length, g = !a.requireSorting && {}, k = d.indexOf(e), B = H(a, q), l; if (!1 !== a.options.includeInDataExport && !a.options.isInternal && !1 !== a.visible) {
                        K(h, function (a) { return a[0] === k }) || h.push([k, x]); for (l = 0; l < f;)z = w(a, q[l], q.length), p.push(z.columnTitle || z), c && m.push(z.topLevelColumnTitle || z), l++; var A = { chart: a.chart, autoIncrement: a.autoIncrement, options: a.options, pointArrayMap: a.pointArrayMap }; a.options.data.forEach(function (c, d) {
                            n && (B = H(a, q, d)); var w = { series: A }; a.pointClass.prototype.applyOptions.apply(w,
                                [c]); c = w.x; var h = a.data[d] && a.data[d].name; l = 0; if (!e || "name" === a.exportKey || !n && e && e.hasNames && h) c = h; g && (g[c] && (c += "|" + d), g[c] = !0); t[c] || (t[c] = [], t[c].xValues = []); t[c].x = w.x; t[c].name = h; for (t[c].xValues[k] = w.x; l < f;)d = q[l], h = w[d], t[c][x + l] = v(B.categoryMap[d][h], B.dateTimeValueAxisMap[d] ? y.dateFormat(b.dateFormat, h) : null, h), l++
                        }); x += l
                    }
            }); for (e in t) Object.hasOwnProperty.call(t, e) && f.push(t[e]); var e = c ? [m, p] : [p]; for (x = h.length; x--;) {
                var A = h[x][0]; var D = h[x][1]; var k = d[A]; f.sort(function (a, c) {
                    return a.xValues[A] -
                        c.xValues[A]
                }); g = w(k); e[0].splice(D, 0, g); c && e[1] && e[1].splice(D, 0, g); f.forEach(function (a) { var c = a.name; k && !J(c) && (k.dateTime ? (a.x instanceof Date && (a.x = a.x.getTime()), c = y.dateFormat(b.dateFormat, a.x)) : c = k.categories ? v(k.names[a.x], k.categories[a.x], a.x) : a.x); a.splice(D, 0, c) })
            } e = e.concat(f); C(this, "exportData", { dataRows: e }); return e
        }; f.prototype.getCSV = function (a) {
            var c = "", d = this.getDataRows(), b = this.options.exporting.csv, f = v(b.decimalPoint, "," !== b.itemDelimiter && a ? (1.1).toLocaleString()[1] : "."),
            l = v(b.itemDelimiter, "," === f ? ";" : ","), g = b.lineDelimiter; d.forEach(function (a, b) { for (var n, y = a.length; y--;)n = a[y], "string" === typeof n && (n = '"' + n + '"'), "number" === typeof n && "." !== f && (n = n.toString().replace(".", f)), a[y] = n; c += a.join(l); b < d.length - 1 && (c += g) }); return c
        }; f.prototype.getTable = function (a) {
            var c = function (a) {
                if (!a.tagName || "#text" === a.tagName) return a.textContent || ""; var d = a.attributes, b = "<" + a.tagName; d && Object.keys(d).forEach(function (a) { b += " " + a + '="' + d[a] + '"' }); b += ">"; b += a.textContent || ""; (a.children ||
                    []).forEach(function (a) { b += c(a) }); return b += "</" + a.tagName + ">"
            }; a = this.getTableAST(a); return c(a)
        }; f.prototype.getTableAST = function (a) {
            var c = 0, b = [], d = this.options, f = a ? (1.1).toLocaleString()[1] : ".", l = v(d.exporting.useMultiLevelHeaders, !0); a = this.getDataRows(l); var g = l ? a.shift() : null, k = a.shift(), m = function (a, c, b, d) { var h = v(d, ""); c = "text" + (c ? " " + c : ""); "number" === typeof h ? (h = h.toString(), "," === f && (h = h.replace(".", f)), c = "number") : d || (c = "empty"); b = F({ "class": c }, b); return { tagName: a, attributes: b, textContent: h } };
            !1 !== d.exporting.tableCaption && b.push({ tagName: "caption", attributes: { "class": "highcharts-table-caption" }, textContent: v(d.exporting.tableCaption, d.title.text ? d.title.text : "Chart") }); for (var p = 0, r = a.length; p < r; ++p)a[p].length > c && (c = a[p].length); b.push(function (a, c, b) {
                var f = [], h = 0; b = b || c && c.length; var n = 0, e; if (e = l && a && c) { a: if (e = a.length, c.length === e) { for (; e--;)if (a[e] !== c[e]) { e = !1; break a } e = !0 } else e = !1; e = !e } if (e) {
                    for (e = []; h < b; ++h) {
                        var g = a[h]; var k = a[h + 1]; g === k ? ++n : n ? (e.push(m("th", "highcharts-table-topheading",
                            { scope: "col", colspan: n + 1 }, g)), n = 0) : (g === c[h] ? d.exporting.useRowspanHeaders ? (k = 2, delete c[h]) : (k = 1, c[h] = "") : k = 1, g = m("th", "highcharts-table-topheading", { scope: "col" }, g), 1 < k && g.attributes && (g.attributes.valign = "top", g.attributes.rowspan = k), e.push(g))
                    } f.push({ tagName: "tr", children: e })
                } if (c) { e = []; h = 0; for (b = c.length; h < b; ++h)"undefined" !== typeof c[h] && e.push(m("th", null, { scope: "col" }, c[h])); f.push({ tagName: "tr", children: e }) } return { tagName: "thead", children: f }
            }(g, k, Math.max(c, k.length))); var u = []; a.forEach(function (a) {
                for (var b =
                    [], d = 0; d < c; d++)b.push(m(d ? "td" : "th", null, d ? {} : { scope: "row" }, a[d])); u.push({ tagName: "tr", children: b })
            }); b.push({ tagName: "tbody", children: u }); b = { tree: { tagName: "table", id: "highcharts-data-table-" + this.index, children: b } }; C(this, "aftergetTableAST", b); return b.tree
            ...
            "name"); b.treemap && (b.treemap.prototype.exportKey = "name")
