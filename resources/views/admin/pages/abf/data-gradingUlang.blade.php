<section class="panel">
    <div class="card-body">
        <div class="float-right mb-3">
            <a href="{{ route('abf.index', array_merge(['key' => 'data-gradul', 'get' => 'unduh'], $_GET)) }}" class="btn btn-success">Unduh</a>
        </div>
        <div class="row">
            <div class="col">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    @if ($row->berat > 0)
                    <br>
                    <a href="{{ route('abf.index', ['key' => 'warehouseGrading']) }}&id={{ $row->id }}" class="btn bnt-sm btn-info mt-2 mb-2">Grading Ulang</a>
                    @endif

                    @if (isset($totalGradingUlang))
                        @if ($totalGradingUlang > 0)
                        <br>
                        <span class="status status-info mt-2">{{ $totalGradingUlang }}  x Grading Ulang</span>
                        @endif
                    @endif
