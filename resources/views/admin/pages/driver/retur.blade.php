...
@section('content')
    <div class="row mb-4">
        <div class="col">
            <a href="{{ route('driver.index') }}" class="btn btn-outline btn-sm btn-back"> <i
                        ...
                        <tbody>
                            ...
                            @foreach ($list as $i => $row)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="submit" class="btn btn-primary btn-block btn-sm goreturdriver"
                                            data-item="{{ $row->id }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.goreturdriver', function() {
                ...
                $.ajax({
                    url: "{{ route('driver.returadddriver') }}",
                    method: "POST",
                    data: {
                        item: item,
                        order: order,
