                ...
                <div class="row mb-1">
                    <div class="col ">
                        <div class="border text-center">
                            <div class="font-weight-bold">{{ number_format($totalberat) }} Kg</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body p-2">
                <div class="row mb-1">
                    <div class="col ">
                        <div class="border text-center">
                            <div class="font-weight-bold">{{ number_format($totalqty) }}</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body p-2">
                <div class="row mb-1">
                    <div class="col ">
                        <div class="border text-center">
                            <div class="font-weight-bold">{{ number_format($totalbatal) }} Kg</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body p-2">
                <div class="row mb-1">
                    <div class="col ">
                        <div class="border text-center">
                            @foreach ($datatotalfrosen as $item)
                                <div class="font-weight-bold">{{ number_format($item->tot_berat_frozen) }} Kg</div>
                            @endforeach
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body p-2">
                <div class="row mb-1">
                    <div class="col ">
                        <div class="border text-center">
                            @foreach ($datatotalfres as $item)
                                <div class="font-weight-bold">{{ number_format($item->tot_berat_fres) }} Kg</div>
                            @endforeach
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body p-2">
                <div class="row mb-1">
                    <div class="col ">
                        <div class="border text-center">
                            <div class="font-weight-bold">{{ number_format($datatotorder) }}</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body p-2">
                <div class="row mb-1">
                    <div class="col ">
                        <div class="border text-center">
                            <div class="font-weight-bold">{{ number_format($sumpending) }}</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body p-2">
                <div class="row mb-1">
                    <div class="col ">
                        <div class="border text-center">
                            <div class="font-weight-bold">{{ number_format($sumbatal) }}</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body p-2">
                <div class="row mb-1">
                    <div class="col ">
                        <div class="border text-center">
                            <div class="font-weight-bold">{{ number_format($sumedit) }}</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body p-2">
                <div class="row mb-1">
                    <div class="col ">
                        <div class="border text-center">
                            <div class="font-weight-bold">{{ number_format($sumapprove) }}</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body p-2">
                <div class="row mb-1">
                    <div class="col ">
                        <div class="border text-center">
                            <div class="font-weight-bold">{{ number_format($sumgagal) }}</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body p-2">
                <div class="row mb-1">
                    <div class="col ">
                        <div class="border text-center">
                            <div class="font-weight-bold">{{ number_format($sumhold) }}</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card card-body px-2 mb-1"
            ...
            <div class="row">
                <div class="col col-sm-12">
                    ...
                    <b>{{ $loop->iteration+($data->currentpage() - 1) * $data->perPage() }}. @if (!empty($ns->failed)) <a href="https://6484226.app.netsuite.com/app/common/entity/custjob.nl?id={{$row->socustomer->netsuite_internal_id}}" target="_blank">{{ $row->socustomer->nama ?? "#CUSTOMERHILANG" }}</a> @else {{ $row->socustomer->nama ?? "#CUSTOMERHILANG" }} @endif  </b> <br>
                    TANGGAL KIRIM : <b>{{ date('d/m/Y', strtotime($row->tanggal_kirim)) }}</b><br>
                    MEMO : <b>{{ $row->memo ?? '#' }}</b> || NO PO : <b>{{ $row->no_po ?? '#' }}</b><br>
            ...
            <div class="mt-1">
                <table class="table default-table">
                    ...
                    <tbody>
                        @php 
                            ...
                            $total_qty      = 0;
                        @endphp
                        @foreach ($row->listItem as $raw)
                            @php 
                                $cekDataList = App\Models\MarketingSOList::cekItemByProduct($raw->item_id);
                            @endphp
                            <tr
                            @if ($raw->deleted_at)
                            ...
                            >
                                ...
                                <td>#{{ $raw->id }}_{{ $raw->line_id }}</td>
                                <td>{{ $raw->item->sku ?? '#' }}</td>
                                <td>{{ $raw->item->nama ?? $raw->item_nama }}</td>
                                <td>{{ $raw->parting }}</td>
                                <td class="text-right">{{ number_format($raw->qty) }}
                                </td>
                                <td class="text-right">
                                    {{ number_format($raw->berat, 2) }}
                                </td>
                                <td>
                                    {{ $raw->plastik }}
                                    @if($raw->plastik=="")
                                    Curah
                                    @elseif($raw->plastik=="1")
                                    Meyer
                                    @elseif($raw->plastik=="2")
                                    Avida
                                    @elseif($raw->plastik=="3")
                                    Polos
                                    @elseif($raw->plastik=="4")
                                    Bukan Plastik
                                    @elseif($raw->plastik=="5")
                                    Mojo
                                    @elseif($raw->plastik=="5")
                                    Other
                                    @endif
                                ...
                                <td>{{ $raw->bumbu }}</td>
                                <td>{{ $raw->memo }}</td>
                                <td>{{ $raw->internal_memo }}</td>
                                <td>{{ $raw->description_item }}</td>
                                <td class="text-right">Rp {{ number_format($raw->harga) }} ({{$raw->harga_cetakan == '1' ? 'Kilogram' : 'Ekor/Pcs/Pack'}})</td>
                                <td class="text-right">
                                    @php 
                                        
                                        if($raw->harga_cetakan=="1"){
                                            $harga = $raw->harga*$raw->berat;
                                        }else{
                                            $harga = $raw->harga*$raw->qty;
                                        }
                                        if (!$raw->deleted_at){
                                            $total_qty      += $raw->qty;
                                            $total_berat    += $raw->berat;
                ...
                || 
                <span class="small">Created at : <b>{{ $row->created_at }}</b> || By <b>{{ $row->souser->name ?? '' }}</b></span>
