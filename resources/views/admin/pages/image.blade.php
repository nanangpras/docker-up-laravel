                ...
                <div class="col-md-6">
                    ...
                    <div class="col-12 col-md-12 col-sm-12 ">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <button type="submit" class="btn btn-blue">Simpan Images</button> &nbsp
            ...
            <div class="col-md-2 col-sm-3" style="padding:0px">
                ...
                <a class="example-image-link" href="{{asset($gallery->path)}}"  data-lightbox="example-set">
                    ...
                    <div class="action-button">
                        <a href="{{url('admin/images/'.$gallery->id.'/edit')}}" class="btn btn-neutral btn-sm"><i class="fa fa-edit"></i></a>
                        <form action="{{ url('admin/images/'.$gallery->id) }}" method="post" onsubmit="return confirm('Do you really delete Data?');">
                            @method('delete')
                            @csrf
                            <input type="hidden" name="url"  value="{{Request::url()}}" required>
                            <button type="submit" class="btn btn-red btn-sm" value="Hapus" onclick="return confirm('Hapus Data?')">
