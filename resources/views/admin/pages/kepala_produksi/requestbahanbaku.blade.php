...
@section('content')
    ...
    <div class="row mb-4">
        <div class="col">
            <a href="{{ route('kepalaproduksi.index') }}" class="btn btn-outline btn-sm btn-back"> <i
                    class="fa fa-arrow-left"></i>
                Back</a>
        </div>
        <div class="col text-center">
            <b>Preparation Kepala Produksi</b>
        </div>
        <div class="col"></div>
    </div>
    <section class="panel">
                ...
                <div class="col">
                    <div class="row">
                        ...
                        <!-- <div class="col">
                            ...
                            <input class="form-control" type="text" value="{{ $item->qty - $bahan['jml_item'] }}" readonly>
                        </div> -->
                    </div>
                </div>
            </div>
                            ...
                            @foreach ($chiller as $chill)
                                <tr>
                                    ...
                                    <td class="text-center" width="200px">
                                        <input type="number" min="0" name="qty" id="qty{{ $chill->id }}" class="form-control">
                                    </td>
                                    <td class="text-center" width="200px">
                                        <input type="number" min="0" name="berat" id="berat{{ $chill->id }}" class="form-control">
                                    </td>
                                    <td class="text-center">
                                        <button type="submit" class="btn btn-success btn-sm masuk"
                                            ...
                                            data-stockberat="{{ $chill->stock_berat }}" data-truck="{{ $chill->chilprod->no_urut }}">Ajukan</button>
                                    </td>
                                </tr>
                            @endforeach
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.masuk', function() {
                ...
                // }
                    ...
                    $.ajax({
                        url: "{{ route('kepalaproduksi.storerequestbahanbaku') }}",
                        method: "POST",
                        data: {
                            item: item,
                            chiller: chiller,
