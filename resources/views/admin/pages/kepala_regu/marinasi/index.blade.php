...
@section('content')
    ...
    <script>
        $("#show_data").load("{{ route('kepalaregu.marinasishow') }}")
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.selesai_freestock', function() {
                ...
                $.ajax({
                    url: "{{ route('kepalaregu.marinasifreestockselesai') }}",
                    method: "POST",
                    data: {
                        row_id: row_id,
                    },
            ...
            $(document).on('click', '.input_freestock', function() {
                ...
                $.ajax({
                    url: "{{ route('kepalaregu.marinasifreestockstore') }}",
                    method: "POST",
                    data: {
                        row_id: row_id,
                        freestock: freestock,
                    ...
                    success: function(data) {
                        ...
                        $.get("{{ route('kepalaregu.marinasifreestock') }}", { 'id' : row_id }, function(data) {
                            $('#tempoarary' + row_id).html(data) ;
                        });

                        $.get("{{ route('kepalaregu.marinasifreestock') }}", { 'list' : row_id }, function(data) {
            ...
            $(document).on('click', '.del_temporary', function() {
                ...
                $.ajax({
                    url: "{{ route('kepalaregu.marinasifreestockdelete') }}",
                    method: "POST",
                    data: {
                        row_id: row_id,
                        item: item,
