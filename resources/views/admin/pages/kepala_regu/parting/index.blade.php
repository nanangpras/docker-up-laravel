...
@section('title', 'Kepala Regu Parting')
@section('content')
    ...
    <script>
        $("#show_data").load("{{ route('kepalaregu.partingshow') }}");
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.selesai_freestock', function() {
                ...
                $.ajax({
                    url: "{{ route('kepalaregu.partingfreestockselesai') }}",
                    method: "POST",
                    data: {
                        row_id: row_id,
                    },
            ...
            $(document).on('click', '.input_freestock', function() {
                ...
                $.ajax({
                    url: "{{ route('kepalaregu.partingfreestockstore') }}",
                    method: "POST",
                    data: {
                        row_id: row_id,
                        freestock: freestock,
                    ...
                    success: function(data) {
                        ...
                        $.get("{{ route('kepalaregu.partingfreestock') }}", {
                            'id': row_id
                        }, function(data) {
            ...
            $(document).on('click', '.del_temporary', function() {
                ...
                $.ajax({
                    url: "{{ route('kepalaregu.partingfreestockdelete') }}",
                    method: "POST",
                    data: {
                        row_id: row_id,
                        item: item,
