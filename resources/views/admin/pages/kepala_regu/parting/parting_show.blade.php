                ...
                <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-three-freestock-tab" data-toggle="pill"
                            ...
                            aria-selected="false">Order Free Stock</a>
                    </li>
                </ul>
                <div class="card-body">
                    <div class="tab-content" id="custom-tabs-three-tabContent">
                                            ...
                                            <div class="col-8">
                                                ...
                                                @foreach (Order::item_order($val->id, 'parting') as $i => $item)
                                                    ...
                                                    <div class="radio-toolbar">
                                                        <input type="radio" id="do-{{ $item->id }}" onclick=''
                                                            data-jenis='' value="{{ $item->id }}" name="purchase"
                                                            required>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group input-group-lg">
                                                                <input type="text" value="{{ number_format($qty) }}"
                                                                    name="jumlah" class="text-right form-control"
                                                                    id="qty" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group input-group-lg">
                                                                <input type="text"
                                                                    value="{{ number_format($berat, 2) }}" name="berat"
                        ...
                        <div class="tab-pane fade" id="custom-tabs-three-freestock" role="tabpanel"
                            aria-labelledby="custom-tabs-three-freestock-tab">
...
<script>
    $("#pending").load("{{ route('kepalaregu.partingpending') }}");
    $("#freestock").load("{{ route('kepalaregu.partingfreestock') }}");
