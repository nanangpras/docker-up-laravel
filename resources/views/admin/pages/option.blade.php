        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <div class="btn-group">
                <a href="javascript:void(0)" class="btn btn-green btn-sm button-edit-options" data-id="{{ $opsi->id }}" data-option_type="{{ $opsi->option_type }}" data-slug="{{ $opsi->slug }}" data-option_name="{{ $opsi->option_name }}" data-option_value="{{ $opsi->option_value }}" data-editable="{{ $opsi->editable }}" data-icon="{{ $opsi->icon }}" data-status="{{ $opsi->status }}" data-update="{{ url('admin/options',$opsi->id) }}" data-position="{{ $opsi->position }}" data-toggle="modal" data-target="#editOption" style="display: inline-block;">
