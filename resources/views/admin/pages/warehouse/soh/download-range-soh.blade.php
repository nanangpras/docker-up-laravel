...
<div id="container">
    <div class="table-responsive table-height">
        <table class="table table-bordered table-striped table-hover table-sticky" border="1">
            <thead>
                <tr>
                    <th class="text-center" colspan="14">SOH TANGGAL {{ date('d-m-Y', strtotime($tanggal_awal_soh)) }} - {{ date('d-m-Y', strtotime($tanggal_akhir_soh)) }}</th>
